...
public class Tasks extends ModelObject{
	...
	public void setTextToNewTaskName(Text textToNewTaskName) {
		this.textToNewTaskName = textToNewTaskName;
	}
	public Text getTextToNewTaskName() {
		return textToNewTaskName;
	}
}
