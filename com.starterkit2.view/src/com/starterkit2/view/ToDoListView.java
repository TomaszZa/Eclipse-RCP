...
public class ToDoListView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		//share text to be newTitle in Handler
		tasks.setTextToNewTaskName(textToEdit);
		
		//actual table
		final TableViewer tableViewer = new TableViewer(parent, SWT.BORDER | SWT.FULL_SELECTION);
		tableActual = tableViewer.getTable();
		//share tableviewer to Handles
		tasks.setTableViewerForFirstTable(tableViewer);
		...
		//share tableviewer to Handlers
		tasks.setTableViewerForSecondTable(tableViewer_1);
		...
		//sending task instance to Handlers
		tasks.setShareToHandlersTask(task);
        //add nutton
